...
class RecettesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recette" do
    assert_difference('Recette.count') do
      post recettes_url, params: { recette: { description: @recette.description, titre: @recette.titre, utilisateur_id: @recette.utilisateur_id } }
    end
  ...
  test "should update recette" do
    patch recette_url(@recette), params: { recette: { description: @recette.description, titre: @recette.titre, utilisateur_id: @recette.utilisateur_id } }

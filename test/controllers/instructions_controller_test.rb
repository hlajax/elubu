...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { etape: @instruction.etape, recette_id: @instruction.recette_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { etape: @instruction.etape, recette_id: @instruction.recette_id } }

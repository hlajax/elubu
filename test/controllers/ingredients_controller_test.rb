...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { recette_id: @ingredient.recette_id, titre: @ingredient.titre } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { recette_id: @ingredient.recette_id, titre: @ingredient.titre } }
